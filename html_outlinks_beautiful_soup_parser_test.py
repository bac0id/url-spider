...
from html_outlinks_beautiful_soup_parser import HtmlOutlinksBeautifulSoupParser

class HtmlOutlinksBeautifulSoupParserTest(unittest.TestCase):

    def setUp(self):
        self.parser = HtmlOutlinksBeautifulSoupParser()
